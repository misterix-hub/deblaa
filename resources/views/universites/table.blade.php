        ...
        @foreach($universites as $universite)
            <tr class="{{ $universite->acces == 'Autorisé' ? 'success' : 'warning' }}">
                ...
                <td class="text-center" width="100">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('universites.show', [$universite->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="{{ route('universites.edit', [$universite->id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
